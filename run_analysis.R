...
## Check the reshape package in your Packages window.
 library(reshape)
 testandtrain$V1.1 <- factor(testandtrain$V1.1, levels = c(1,2,3,4,5,6), labels = c("WALKING", "WALKING_UPSTAIRS", 
 "WALKING_DOWNSTAIRS", "SITTING", "STANDING", "LAYING"))
## Rename all column names
 library(plyr)
 testandtraindataframe <- rename(testandtrain, c(V1="ExperimentVolunteerID", V1.1="ActivityofVolunteer", 
                                                V1.2="TimeBodyAccelerometerMeanX",
